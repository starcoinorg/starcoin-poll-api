...
public class PollController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "description", value = "中文说明", required = true, dataType = "String", dataTypeClass = String.class),
            @ApiImplicitParam(name = "descriptionEn", value = "英文说明", required = true, dataType = "String", dataTypeClass = String.class),
            ...
            @ApiImplicitParam(name = "title", value = "中文标题", required = true, dataType = "String", dataTypeClass = String.class),
            @ApiImplicitParam(name = "titleEn", value = "英文标题", required = true, dataType = "String", dataTypeClass = String.class),
